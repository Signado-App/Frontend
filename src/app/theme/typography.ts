...
export const typography = {
  ...
  h1: { fontSize: '3.5rem', fontWeight: 500, lineHeight: 1.2, fontFamily: '"Open Sans", system-ui'},
  h2: { fontSize: '3rem', fontWeight: 500, lineHeight: 1.2, fontFamily: '"Open Sans", system-ui' },
  h3: { fontSize: '2.25rem', fontWeight: 500, lineHeight: 1.2, fontFamily: '"Open Sans", system-ui' },
