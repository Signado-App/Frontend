...
export type FeatureBigRightProps = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const FeatureBigRight = (props: FeatureBigRightProps) => {
  const { tagline, heading, description, card } = {
    ...props,
    ...FeatureBigRightDefaults,
  };
  return (
...
export const FeatureBigRightDefaults: Props = {
  tagline: "Tagline",
