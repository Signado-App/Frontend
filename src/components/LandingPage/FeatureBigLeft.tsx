...
export type FeatureBigLeftProps = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const FeatureBigLeft = (props: FeatureBigLeftProps) => {
  const { tagline, heading, description, card } = {
    ...props,
    ...FeatureBigLeftDefaults,
  };
  return (
...
export const FeatureBigLeftDefaults: Props = {
  tagline: "Tagline",
