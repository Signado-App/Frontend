...
export const shadows = [
  ...
  '0px 1px 14px rgba(0, 0, 0, 0.3)',
  '0px 1px 18px rgba(0, 0, 0, 0.3)',
  ...
  '0px 5px 26px rgba(0, 0, 0, 0.3)',
  '0px 6px 28px rgba(0, 0, 0, 0.3)',
  '0px 6px 30px rgba(0, 0, 0, 0.3)',
  '0px 6px 32px rgba(0, 0, 0, 0.3)',
  '0px 7px 34px rgba(0, 0, 0, 0.3)',
  '0px 7px 36px rgba(0, 0, 0, 0.3)',
  '0px 8px 38px rgba(0, 0, 0, 0.3)',
  '0px 8px 40px rgba(0, 0, 0, 0.3)',
  '0px 8px 42px rgba(0, 0, 0, 0.3)',
  '0px 9px 44px rgba(0, 0, 0, 0.3)',
  '0px 9px 46px rgba(0, 0, 0, 0.3)',
] satisfies Shadows;
